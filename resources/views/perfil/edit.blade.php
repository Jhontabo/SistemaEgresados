                        ...
                        <div>
                            ...
                            <select name="estado_laboral"
                                ...
                                <option value="empleado"
                                    {{ old('estado_laboral', $user->estado_laboral) == 'empleado' ? 'selected' : '' }}>
                                    Empleado</option>
                                <option value="desempleado"
                                    {{ old('estado_laboral', $user->estado_laboral) == 'desempleado' ? 'selected' : '' }}>
                                    Desempleado</option>
                                <option value="estudiante"
                                    {{ old('estado_laboral', $user->estado_laboral) == 'estudiante' ? 'selected' : '' }}>
                                    Estudiante</option>
                            </select>
                        </div>
                    </div>
